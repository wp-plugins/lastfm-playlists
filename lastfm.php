...
function lastfm($content) {
	...
	$feed = file_get_contents("http://ws.audioscrobbler.com/2.0/?method=user.getplaylists&user=" . $user . "&api_key=" . $api); // get playlists of the last.fm user
	...
	$tracks = file_get_contents("http://ws.audioscrobbler.com/2.0/?method=playlist.fetch&playlistURL=lastfm://playlist/" . $playlistid  . "&api_key=" . $api); // get the tracklist from the playlist
